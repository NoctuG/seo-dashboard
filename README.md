...
- You can copy from `backend/.env.example` and `frontend/.env.example`.

### AI Feature

- A new **AI Assistant** page is available in the sidebar.
- Paste SEO content and get optimization suggestions generated by your configured AI API.
