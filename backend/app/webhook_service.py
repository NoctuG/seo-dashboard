...
WEBHOOK_EVENT_CRAWL_STARTED = "crawl.started"
...
WEBHOOK_EVENT_SERVER_ERROR_SURGE = "crawl.server_error_surge"

TOP_10_THRESHOLD = 10
SIGNIFICANT_RANK_DROP_MIN_DELTA = 5
SITE_AUDIT_LOW_SCORE_THRESHOLD = 80
SERVER_ERROR_SURGE_THRESHOLD = 5  # number of 5xx errors in a single crawl that triggers alert
