...
class Settings:
    ...
    SIMILARWEB_BASE_URL: str = os.getenv("SIMILARWEB_BASE_URL", "https://api.similarweb.com")
    SIMILARWEB_TIMEOUT_SECONDS: int = int(os.getenv("SIMILARWEB_TIMEOUT_SECONDS", "8"))
    SIMILARWEB_MAX_RETRIES: int = int(os.getenv("SIMILARWEB_MAX_RETRIES", "2"))
    SIMILARWEB_RETRY_BACKOFF_SECONDS: float = float(os.getenv("SIMILARWEB_RETRY_BACKOFF_SECONDS", "0.5"))
