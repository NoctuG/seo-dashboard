...
from app.api.endpoints import admin_backup, ai, ai_commands, ai_drafts, ai_orchestration, api_keys, auth, competitors, crawls, health, issues, keywords, pages, projects, users, version, webhooks
...
api_router.include_router(competitors.router, prefix="/projects", tags=["competitors"], dependencies=[Depends(get_current_user)])

api_router.include_router(ai.router, prefix="/ai", tags=["ai"], dependencies=[Depends(get_current_user)])
api_router.include_router(ai_commands.router, prefix="/ai", tags=["ai-commands"], dependencies=[Depends(get_current_user)])
api_router.include_router(ai_orchestration.router, prefix="/ai", tags=["ai-orchestration"], dependencies=[Depends(get_current_user)])
...
api_router.include_router(ai_drafts.router, tags=["ai-drafts"], dependencies=[Depends(get_current_user)])
